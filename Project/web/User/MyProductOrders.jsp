    ...
    <html lang="en">
        ...
        <body>
            ...
            <%
                ...
                String Sel = "select * from tbl_productbook o inner join tbl_products p on o.product_id=p.Product_id where o.user_id='" + session.getAttribute("uid") + "'";
                ResultSet rs = obj.selectCommand(Sel);
//                out.print(Sel);
                while (rs.next()) {
                    vstatus = rs.getString("pb_vstatus");
                    cstatus = rs.getString("pb_cstatus");
                    i++;
