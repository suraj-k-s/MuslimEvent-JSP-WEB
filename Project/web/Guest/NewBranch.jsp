...
<html lang="en">
    ...
    <body>
        ...
        <div class="signup-wrapper">
            ...
            <form method="post" enctype="multipart/form-data" action="HPBranchUploadAction.jsp"> 
                    ...
                    <div class="outer-panel-inner">
                       ...
                       <div id="signup-panel-2" class="process-panel-wrap is-narrow is-active">
                            <div class="form-panel">
                                ...
                                <div class="field">
                                    <label>Land Mark 1</label>
                                    <div class="control">
                                        <input type="text" required="" name="lname" class="input" placeholder="Enter  Landmark 1">
                                    </div>
                                </div>
                                <div class="field">
                                    <label>Land Mark 1</label>
                                    <div class="control">
                                        <input type="text" required="" name="mname" class="input" placeholder="Enter  Landmark 2">
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="form-panel">
                                <div class="photo-upload">
                                    ...
                                    <div class="limitation">
                                        ...
                                        Logo <input required="" type="file" name="file_photo">
                                        <br><br>
