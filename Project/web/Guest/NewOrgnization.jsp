...
<html lang="en">
    ...
    <body>
        ...
        <div class="signup-wrapper">
            ...
            <form method="post" enctype="multipart/form-data" action="EventOrgUploadAction.jsp"> 
                       ...
                       <div id="signup-panel-2" class="process-panel-wrap is-narrow is-active">
                            <div class="form-panel">
                                ...
                                <div class="field">
                                    ...
                                    <div class="control">
                                        <input type="text" required="" name="lname" class="input" placeholder="Enter  License Number ">
                                    </div>
                                </div>
                            </div>
