...
<html lang="en">
    ...
    <body>
        ...
        <div class="signup-wrapper">
            ...
            <form method="post" enctype="multipart/form-data" action="UserUploadAction.jsp"> 
                            ...
                            <div class="form-panel">
                                <div class="photo-upload">
                                    ...
                                    <div class="limitation">
                                        Photo <input required="" type="file" name="file_photo">
                                        <br><br>
                        ...
                        <div id="signup-panel-4" class="process-panel-wrap is-narrow">
                            <div class="form-panel">
                                ...
                                <div class="field">
                                    ...
                                    <div class="control">
                                        <input type="password" required="" pattern="(?=.*\d)(?=.*[a-z])(?=.*[A-Z]).{8,}"
                                               title="Must contain at least one  number and one uppercase and lowercase letter, and at least 8 or more characters" name="cpname" class="input" placeholder="Choose a password">
                                    </div>
                                </div>
                            </div>
