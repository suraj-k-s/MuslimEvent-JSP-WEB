<%-- 
    ...
    Created on : 23 Jan, 2021, 11:52:04 AM
    Author     : HP
--%>
...
<html>
    <head>
        ...
        <title>Change Password</title> <%@include file="tem.jsp" %>
    </head>
    <body>
        <%
             
       
            String eid="", eventorg_CurrentPassword="",current_password="",New_password="",Confirm_password="";
          ...
          {    
              ...
              eventorg_CurrentPassword=rs1.getString("eventorg_password");
             
           
          }
               
               
                if( eventorg_CurrentPassword.equals(current_password))
                {
                   if(New_password.equals(Confirm_password))
                   {
                       
                     String up="update tbl_eventorg set eventorg_password='"+New_password+"'where  eventorg_id='"+eid+"'";
